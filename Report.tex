...
\begin{figure}[H]
\begin{tikzpicture}
  [->,node distance=2cm and 2cm, main node/.style={rectangle,fill=blue!8,draw,font=\sffamily\bfseries}] 
  \node[main node]  	(ScanForMatches)                        {\scm};
  \node[main node] 	(Parser) [below= of ScanForMatches]   {Parse \pus};
%  \node[main node] 	(PUnit) [right= of Parser]   {PUnit};
  \node[main node]  	(PatternMatch)  [below= of Parser]  {Begin match from data pointer p};
  \node[main node]	(PUnit1)		[right= of PatternMatch] {First \pu match?};
  \node[main node]	(PUnit2)		[below= of PUnit1] {Secound \pu match?};
  \node[main node]	(PUnitn)		[below= of PUnit2] {n'th \pu match?};
...
%  \node[main node]	(Resultn)		[right= of PUnitn] {Result};
  ...
  \node[main node]	(NextHit)		[below= of to2NextHit] {End of file?};
  \node[main node]	(Return)			[below= of NextHit] {Return};
  
  
  \path[every node/.style={font=\sffamily\small}]
    (ScanForMatches) 	edge node [left] {} (Parser)
%    (Parser) 			edge node [left] {} (PUnit)
	(Parser)			edge node [left] {} (PatternMatch)
    (PatternMatch) 		edge node [above] {not EOF} (PUnit1)
    						edge [bend right] node [left] {EOF} (Return)
    (PUnit1)  				edge [bend right] node [left] {Yes: p+=len(PUnit1)} (PUnit2)
    						edge [bend right] node [above] {No: p++} (PatternMatch)
    (PUnit2)				edge [bend right] node [left] {Yes: p+=len(PUnit2)} (PUnitn)
    						edge [bend right] node[align=center] [right] {No: p -= len(PUnit1)\\ try another match} (PUnit1)
    (PUnitn)				edge node[align=center] [below] {Whole pattern match:\\ p+=len(n'th PUnit) \\ 
    							print match} (NextHit)
    						edge [bend right] node[align=center] [right] {No: p -=len(PUnit2)\\ try another match} (PUnit2)
...
%        					edge node [below] {BACKTRACK} (PUnit2)
    (NextHit)			edge node [right] {not EOF} (PatternMatch)
        					edge node [right] {EOF} (Return)
    ;
    
\end{tikzpicture} 
\caption{\textit{Simplistic flow chart of pattern matching in} \texttt{scan\_for\_matches}\textit{. p is a pointer to
data and is initially set to start of data. Notice that overlapping matches will no be found.}} 
\end{figure} 
...
\node[main node](1)    			  {A};
\node[main node](2) [right= of 1] {T};
\node[main node](3) [right= of 2] {T};
\node[main node](4) [right= of 3] {T};
\node[main node](5) [right= of 4] {T};
\node[main node](6) [right= of 5] {G};

\node[main node](7) [below= of 1] {A};
\node[main node](8) [right= of 7] {--};
\node[main node](9) [right= of 8] {--};
\node[main node](10) [right= of 9] {T};
\node[main node](11) [right= of 10] {T};
\node[main node](12) [right= of 11] {G};


\node[main node](13) [right= of 6, xshift=+2cm] {A};
\node[main node](14) [right= of 13] {T};
\node[main node](15) [right= of 14] {T};
\node[main node](16) [right= of 15] {T};
\node[main node](17) [right= of 16] {T};
\node[main node](18) [right= of 17] {G};

\node[main node](19) [below= of 13] {A};
\node[main node](20) [right= of 19] {T};
\node[main node](21) [right= of 20] {T};
\node[main node](22) [right= of 21] {--};
\node[main node](23) [right= of 22] {--};
\node[main node](24) [right= of 23] {G};

\path[every node/.style={font=\sffamily\small}]
(2) edge node [left] {deletion} (8)
(3) edge node [right] {deletion} (9)
(16) edge node [left] {deletion} (22)
(17) edge node [right] {deletion} (23)
;
\end{tikzpicture}
...
Backtracking is a commonly used technique in string searching functionality and is the foundational algorithm of the string
search in \scm and in our re-implementation. The problem of determining a match between two strings are closely
related to the Levenshtein distance problem although it has important differences. \\ \\
...
\node[main node](8)	[below= of 1] {A};
\node[main node](9) [right= of 8] {--};
\node[main node](10)[right= of 9] {T};
\node[main node](11)[right= of 10] {G};
\node[main node](12)[right= of 11] {T};
\node[main node](13)[right= of 12] {C};
\node[main node](14)[right= of 13] {A};

\node[main node](21)[right= of 7, xshift=+2cm] {A};
\node[main node](22)[right= of 21] {--};
\node[main node](23)[right= of 22] {T};
\node[main node](24)[right= of 23] {G};
\node[main node](25)[right= of 24] {T};
\node[main node](26)[right= of 25] {C};
\node[main node](27)[right= of 26] {A};

\node[main node](15)[above= of 21] {A};
\node[main node](16)[right= of 15] {C};
\node[main node](17)[above= of 23] {T};
\node[main node](18)[above= of 24] {G};
\node[main node](19)[above= of 25] {C};
\node[main node](20)[above= of 26] {A};


\node[main node](28)[below= of 21] {A};
\node[main node](29)[right= of 28] {C};
\node[main node](30)[right= of 29] {T};
\node[main node](31)[right= of 30] {G};
\node[main node](32)[right= of 31] {C};
\node[main node](33)[right= of 32] {A};

\node[main node](34)[below= of 28] {A};
\node[main node](35)[right= of 34] {T};
\node[main node](36)[right= of 35] {--};
\node[main node](37)[right= of 36] {G};
\node[main node](38)[right= of 37] {T};
\node[main node](39)[right= of 38] {C};
\node[main node](40)[right= of 39] {A};

\path[every node/.style={font=\sffamily\small}]
(2) edge node [left] {deletion} (9)
(5) edge node [left] {insertion} (12)
(16) edge node [left] {deletion} (22)
(19) edge node [left] {mismatch} (25)
(20) edge [color=red] node [right, color=red] {no more edits} (26)
(29) edge node [left] {mismatch} (35)
(30) edge node [right] {deletion} (36)
(32) edge [color=red] node [right, color=red] {no more edits} (38)
;
\end{tikzpicture}
...
\node[main node](6) [right= of 5] {A};
\node[main node](7) [right= of 6] {T};
\node[main node](8) [right= of 7] {T};

\node[main node](9)	[below= of 1] {C};
\node[main node](10)[right= of 9] {T};
\node[main node](11)[right= of 10] {A};
\node[main node](12)[right= of 11] {G};
\node[main node](13)[right= of 12] {A};
\node[main node](14)[right= of 13] {G};
\node[main node](15)[right= of 14] {G};
\node[main node](16)[right= of 15] {T};

\node[main node](17)[right= of 7, xshift=+3cm]  {C};
\node[main node](18)[right= of 17] {T};
\node[main node](19)[right= of 18] {A};
\node[main node](20)[right= of 19] {G};
\node[main node](21)[right= of 20] {C};
\node[main node](22)[right= of 21] {A};
\node[main node](23)[right= of 22] {T};
\node[main node](24)[right= of 23] {T};

\node[main node](25)[below= of 17] {C};
\node[main node](26)[right= of 25] {T};
\node[main node](27)[right= of 26] {A};
\node[main node](28)[right= of 27] {G};
\node[main node](29)[right= of 28] {*};
\node[main node](30)[right= of 29] {A};
\node[main node](31)[right= of 30] {G};
\node[main node](32)[right= of 31] {G};
\node[main node](33)[right= of 32] {T};

\path[every node/.style={font=\sffamily\small}]
(5) edge node [left] {mismatch} (13)
(6) edge node {mismatch} (14)
(7) edge [color=red] node [right, color=red] {only 1 deletion left} (15)
(21) edge node [left] {deletion} (29)
(23) edge node {mismatch} (31)
(24) edge node [right] {mismatch} (32)
;
\end{tikzpicture}
\caption{\textit{In the leftmost example the} \pu \texttt{AGCA} \textit{chose to use 2 mismatches to match the 
data sub-sequence} \texttt{AGAG} \textit{and then move on the next} \pup \textit{The next} \pu
\textit{would then have to match it's letters} \texttt{TT} \textit{with the data sub-sequence} \texttt{GT}
\textit{which it can't do with its remaining deletion. The overall algorithm would have to backtrack the the second
} \pu \textit{to try another possible match (if any) to see if that would make a difference. The rightmost example
shows how using a deletion to delete the C in} \texttt{AGCA} \textit{would also match data} \texttt{AGA} \textit{and
when moving forward to the next} \pu \texttt{TT} \textit{will actually match} \texttt{GG} \textit{by using the two
...
\begin{center}
\begin{tikzpicture}
[->,node distance=2cm and 0.2cm, main node/.style={rectangle,fill=blue!8,draw,font=\sffamily\bfseries}] 
\node[main node](1)				  {AGC[1,0,1]};
\node[main node](2) [below= of 1] {TCT[0,0,1]};
\node[main node](3) [below= of 2] {TG};
\node[main node](4)[below= of 3] {more \pus};

\node[main node](5) [right= of 1, xshift=+5cm] {ACC...};
\node[main node](6) [right= of 2, xshift=+3cm] {CTC...};
\node[main node](7) [right= of 3, xshift=+2cm] {CT...};
\node[main node](8) [right= of 2, xshift=+7cm] {TCT...};
\node[main node](9) [right= of 3, xshift=+6cm] {TTG};
\node[main node](10)[right= of 3, xshift=+10cm] {TG};
\node[main node](11)[right= of 4, xshift=+8.5cm] {more data};

\path[every node/.style={font=\sffamily\small}]
(5) edge node [left] {delete G} (6)
(6) edge node [left] {delete first T} (7)
(5) edge node [right] {mismatch G} (8)
(8) edge node [left] {delete last T} (9)
(8) edge node [right] {straight match} (10)
(10) edge node [left] {straight match} (11)
(7) edge [color=red] node [above] {no possible} (3)
(7) edge [color=red] node [below] {match} (3)
(9) edge [bend left, color=red] node [below, color=red] {no possible match} (3)
;
\end{tikzpicture}
\end{center}
\caption{\textit{Each node shows the relevant data that needs to match the} \texttt{PUnit} 
\textit{on the left side of the tree, and each edge between nodes shows the combination chosen to match that data.
The first} \pu \textit{has two ways of matching it's data. Say the G is deleted to match with data} \texttt{AC}.
\textit{The second} \pu \textit{has only one way of matching with data} \texttt{CTC} \textit{that is by deleting the
first T. The third} \pu \textit{can not match the data} \texttt{CT}. \textit{If mismatching with the G for the first}
\pu \textit{was chosen instead, the second} \pu \textit{would have two possible ways of matching with the data} \texttt{TCT}.
\textit{If the second T is deleted, the third} \pu \textit{would again have no way of matching with data} \texttt{TT}
\textit{but if no edits are used and the straight match is chosen, the third} \pu \textit{would be able to do a
straight match, and the tree would continue to branch downwards to the subsequent} PU's.}
\end{figure}
\noindent So even though the number of combinations that should possibly be tried outgrows exponentially, 
...
Consider the pattern \texttt{AGGT[0,1,1]\; 4...5\; TTCTAA[0,2,1]}. \\ \\
